          ...
          body: JSON.stringify({
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff; color: #1e293b;">
                <h2 style="color: #00628c; margin-top: 0; font-size: 20px; font-weight: 800; border-bottom: 2px solid #f1f5f9; padding-bottom: 12px;">🔔 Novo Candidato/Talento Recebido!</h2>
                <p style="font-size: 14px; line-height: 1.6; color: #334155;">Um novo currículo/perfil de candidato foi cadastrado no site e está aguardando revisão no Painel Admin.</p>
                
                <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 16px; margin: 20px 0; border-radius: 12px;">
                  <h3 style="margin-top: 0; font-size: 16px; color: #0f172a;">Detalhes do Candidato</h3>
                  <table style="width: 100%; font-size: 13px; color: #475569; border-collapse: collapse;">
                    <tr>
                      <td style="padding: 6px 0; font-weight: bold; width: 120px;">Nome:</td>
                      <td style="padding: 6px 0; color: #010101;">${formData.name}</td>
                    </tr>
                    <tr>
                      <td style="padding: 6px 0; font-weight: bold;">Função/Cargo:</td>
                      <td style="padding: 6px 0; color: #010101;">${formData.role}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="padding: 6px 0; font-weight: bold;">Localidade:</td>
                      <td style="padding: 6px 0; color: #010101;">${formData.location || 'Não informado'}</td>
                    </tr>
                  </table>
                </div>
